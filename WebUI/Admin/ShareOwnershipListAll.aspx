...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>所有股东股权</h1>
    <p>
        以下所列人员全部为股东，非股东，或已退出股权人员已不在内。<br />
        股东总数：<asp:Label ID="lbSh" runat="server" Text=""></asp:Label><br />
        股权总数：<asp:Label ID="lbShO" runat="server" Text=""></asp:Label>
    </p>
    ...
    <asp:GridView ID="gvShareOwnership" runat="server" AllowSorting="True" ShowFooter="True"
        DataSourceID="odsSO" AutoGenerateColumns="False" OnDataBound="gvShareOwnership_DataBound">
        <Columns>
