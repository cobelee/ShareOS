...
public partial class Admin_Trade_PrintApplyReport_PrintView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            hfShareholderNumbers.Value = Session["ShareholderNumbers"].ToString();
            Load_Report();
        }
    }

    protected DataTable GetDataSource(string strShNums)
    {
        ...
        return bll_shareOwnership.GetShareOwnershipReport(intArrayShNums);
    }
    ...
    private void Load_Report()
    {
        ...
        reportPrinter.LocalReport.DisplayName = "股权受让申请表";
