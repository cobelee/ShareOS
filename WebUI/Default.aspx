...
<body>
    <form id="form1" runat="server">
        ...
        <div id="wrap">
            <!--header -->
            <div id="header" style="font-weight: bold; font-size: 12pt; color: #333333">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;镇海石化工业贸易有限责任公司股权查询系统
                <div id="header-links">
                    <p>
                        <a href="index.html">Home</a> | <a href="index.html">Contact</a> | <a href="index.html">
                            Site Map</a>
                    </p>
                </div>
                <!--header ends-->
            ...
            <div id="content-wrap" class="two-col">
                <div id="sidebar">
                    ...
                    <ul class="sidemenu">
                        ...
                        <li><a href="http://www.dreamhost.com/r.cgi?287326">Dreamhost.com</a></li>
                    </ul>
                    <h1>
                        Wise Words</h1>
                    <p>
                ...
                <div id="main">
                    ...
                    <h1>
                        Template Info</h1>
                    <p class="post-by">
                        Posted by <a href="index.html">ealigam</a></p>
                    <p>
                        <strong>Marketplace 1.0</strong> is a free, W3C-compliant, CSS-based website template
                        by <strong><a href="http://www.styleshout.com/">styleshout.com</a></strong>. This
                        work is distributed under the <a rel="license" href="http://creativecommons.org/licenses/by/2.5/">
                            Creative Commons Attribution 2.5 License</a>, which means that you are free
                        to use and modify it for any purpose. All I ask is that you include a link back
                        to <a href="http://www.styleshout.com/">my website</a> in your credits.</p>
                    <p>
                        For more free designs, you can visit <a href="http://www.styleshout.com/">my website</a>
                    ...
                    <p class="post-footer">
                        <a href="index.html" class="readmore">Read more</a> | <a href="index.html" class="comments">
                            Comments (7)</a> | <span class="date">May 20, 2007</span>
                    </p>
                    <a name="SampleTags"></a>
                    <h1>
                        Sample Tags</h1>
                    ...
                    <p>
                        <a href="http://getfirefox.com/">
                            <img src="~/App_Themes/Default/Images/firefox-gray.jpg" width="100" height="120" alt="firefox" class="float-left" /></a>
                        ...
                        ipsum. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec libero. Suspendisse
                        bibendum. Cras id urna. Morbi tincidunt, orci ac convallis aliquam, lectus turpis
                        varius lorem, eu posuere nunc justo tempus leo.
                    </p>
                    <h3>
                        Table Styling</h3>
                    <table>
                        ...
                        <tr class="row-a">
                            <td class="first">
                                04.18.2007</td>
                            <td>
                                <a href="index.html">Augue non nibh</a></td>
                            <td>
                                <a href="index.html">Lobortis commodo metus vestibulum</a></td>
                        </tr>
                        <tr class="row-b">
                            <td class="first">
                                04.18.2007</td>
                            <td>
                                <a href="index.html">Fusce ut diam bibendum</a></td>
                            <td>
                                <a href="index.html">Purus in eget odio in sapien</a></td>
                        </tr>
                        <tr class="row-a">
                            <td class="first">
                                04.18.2007</td>
                            <td>
                                <a href="index.html">Maecenas et ipsum</a></td>
                            <td>
                                <a href="index.html">Adipiscing blandit quisque eros</a></td>
                        </tr>
                        <tr class="row-b">
                            <td class="first">
                                04.18.2007</td>
                            <td>
                                <a href="index.html">Sed vestibulum blandit</a></td>
                            <td>
                                <a href="index.html">Cras lobortis commodo metus lorem</a></td>
                        </tr>
                    </table>
                    <h3>
                        Example Form</h3>
            ...
            <!-- footer starts --><div id="footer-wrap">
                <div id="footer">
                    <p>
                        &copy; 2006 <strong>Your Company</strong> | Design by: <a href="http://www.styleshout.com/">
